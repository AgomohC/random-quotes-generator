...
const SingleQuote = ({ author, quote, changeQuote }) => {
  return (
    <section className="container">
      <div className="row">
        <div className="col d-flex align-items-center height">
          <article className="col-md-6 mx-auto p-5 shadow-lg transition bg-light rounded">
            <blockquote className="mb-3 blockquote h2 text-primary d-flex">
              <p className="h5 transition">
                <FaQuoteLeft className="mr-3" />
                {quote}
              </p>
            </blockquote>
            <p className="text-primary text-right transition">- {author}</p>
